#ifndef DATA_OBJECT_DICTIONARIES_NEW_H
#define DATA_OBJECT_DICTIONARIES_NEW_H
...
enum ObjectDictionaryRoutineOnoff {
    ROUTINE_OFF = (uint8_t)0,
    ROUTINE_ON = (uint8_t)1
} ;

enum ObjectDictionaryStateStatus {
    STATE_IDLE,
    STATE_STANDBY,
    STATE_ENABLE,
    STATE_ERROR,
...
enum ObjectDictionaryDataTypeEnum {
    /* DO NOT CHANGE */
    UINT8_T   = 1,
    UINT16_T  = 2,
    UINT32_T  = 3,
...
#endif // DATA_OBJECT_DICTIONARIES_NEW_H
